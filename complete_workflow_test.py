...
def main():
    ...
    print(f"🚀 온라인 평가 시스템 완전 워크플로우 테스트 시작")
    print(f"📍 대상 서버: {backend_url}")
    print(f"⏰ 시작 시간: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    
    # Setup tester
    tester = ComprehensiveWorkflowTester(backend_url)
