...
def main():
    ...
    print("🔧 CLI 명령어:")
    print("   # 포트 할당")
    print("   python -m universal_port_manager.cli allocate frontend backend mongodb redis --project online-evaluation")
    print()
    print("   # 설정 파일 생성") 
    print("   python -m universal_port_manager.cli generate --project online-evaluation")
    print()
    print("   # 서비스 시작")
    print("   python -m universal_port_manager.cli start --project online-evaluation")
    print()
    print("   # 상태 확인")
    print("   python -m universal_port_manager.cli status --project online-evaluation")
